        ...
        child: ListView(
          ...
          children: [
                ...
                children: [
                  ...
                  Expanded(
                    child: Column(
                      ...
                      children: [
                        Text(l10n.needMoreHelp, style: GoogleFonts.poppins(fontWeight: FontWeight.w600)),
                        const SizedBox(height: 2),
                        Text(l10n.emailSupportAddress, style: GoogleFonts.poppins(fontSize: 13, color: Colors.grey.shade600)),
                      ],
                    ),
                  ),
                ],
            ...
            if (_faqs == null)
              ...
              Text(l10n.noFaqsAvailable, style: GoogleFonts.poppins(color: Colors.grey.shade500))
            else
