...
// new category the admin adds shows up without an app update.
class VehicleCategoryModel {
  final String vehicleType; // stable slug, e.g. 'flat_bed_20ft' - what's actually sent to the booking API
