...
// app-wide) - so a driver can see exactly how big "Large" actually looks
// before committing to it, without a separate slider+preview screen.
    ...
    return Scaffold(
      ...
      body: SafeArea(
        child: ListView(
          ...
          children: [
            Text(l10n.textSizeScreenHint, style: const TextStyle(color: AppTheme.textGrey)),
            ...
            ...kTextSizeOptions.map((option) {
              ...
              return Card(
                ...
                shape: RoundedRectangleBorder(
                  ...
                  side: BorderSide(color: isSelected ? AppTheme.amber : AppTheme.borderColor, width: isSelected ? 2 : 1),
                ),
                child: ListTile(
                  ...
                  subtitle: Padding(
                    ...
                    child: MediaQuery(
                      ...
                      child: Text(l10n.textSizeSampleText, style: const TextStyle(color: AppTheme.textGrey)),
                    ),
                  ),
