...
// the web block from the Firebase Console's "Web" app registration (shared
// with the customer app - Firebase web apps aren't package-name-scoped, so
// one web app registration covers both Flutter projects).
