 ...
 */
export default function KpiCard({ label, value, unit, trend, mono = false }) {
  const trendPositive = trend >= 0;
  return (
    <div className="bg-panel border border-line rounded-xl shadow-sm p-4 flex flex-col gap-2">
