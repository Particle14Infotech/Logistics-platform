...
export default function ConsoleShell({
  ...
  return (
    <div className="min-h-screen flex bg-ink text-paper font-body">
      <Sidebar items={navItems} brandSuffix={brandSuffix} footerLabel={footerLabel} onSignOut={handleSignOut} />
      <div className="flex-1 flex flex-col min-w-0">
        <Topbar userName={displayName} userRole={displayRole} dateLabel={dateLabel} />
